            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="border-l-2 border-amber-600 pl-6">
                  <h4 className="text-lg font-medium text-gray-900 mb-2">Sasaab Airstrip</h4>
                  <p className="text-gray-600 font-light leading-relaxed mb-3">
                    Daily flights available from Wilson Airport, Nairobi to Sasaab airstrip.
                  </p>
                ...
                <div className="border-l-2 border-amber-600 pl-6">
                  <h4 className="text-lg font-medium text-gray-900 mb-2">Kalama Airstrip</h4>
                  <p className="text-gray-600 font-light leading-relaxed mb-3">
                    Alternative airstrip with charter flight options.
                  </p>
                  <ul className="space-y-2 text-gray-600 font-light">
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-green-600 mr-2 mt-1 flex-shrink-0" />
                      1 hour drive to lodge (30km)
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-green-600 mr-2 mt-1 flex-shrink-0" />
